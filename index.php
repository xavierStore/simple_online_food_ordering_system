    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <div class="container">
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="ordering.php" novalidate="novalidate">
            <div class="row">
              ...
              <div>
				...
				{
					echo '<tr><td><center><img src='.$row["image"].'></center></td><td>'.$row["name"].'</td><td>'.$row["price"].'</td>';                      
					echo '<td><div class="input-field col s12"><label for='.$row["id"].' class="">Quantity</label>';
					echo '<input id="'.$row["id"].'" name="'.$row['id'].'" type="text" value="0" data-error=".errorTxt'.$row["id"].'"><div class="errorTxt'.$row["id"].'"></div></td></tr>';
				}
				?>
                    </tbody>
</table>
