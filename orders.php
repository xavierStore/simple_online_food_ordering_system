  ...
  <div id="main">
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <div class="container">
          <p class="caption">All orders and delivery will be listed here</p>
					...
					while($row = mysqli_fetch_array($sql))
					{
						...
						while($row1 = mysqli_fetch_array($sql1))
						{
							...
							$id = $row1['order_id'];
                                ...
                                echo'<form action="qrordersummary.php" method="post">
										<input type="hidden" value="'.$id.'" name="id">
										<input type="hidden" value="Cancelled by Customer" name="status">	
										<input type="hidden" value="'.$row['payment_type'].'" name="payment_type">											
                                        <button class="btn waves-effect waves-light right purple submit" type="submit" name="action">Generate QR
                                              </button>
										</form>';
								}
								echo'</div></li>';
