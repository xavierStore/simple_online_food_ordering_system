...
{
		$inquiry_id = $_GET['id'];
		$sql1 = "SELECT * FROM inquiry where poster_id = $user_id AND id = $inquiry_id AND not deleted;";
...
<head>
  ...
  <title>Inquiry No. <?php echo $inquiry_id.' - '. $type;?></title>
...
<div class="section">
								...
								echo '<ul id="task-card" class="collection with-header">
									<div id="card-alert" class="card cyan">
										...
										<span class="card-title white-text darken-1">Inquiry No. '.$inquiry_id.'</span>
										<p><strong>Subject: </strong>'.$subject.'</p>
										<p><strong>Status: </strong>'.$status.'</p>	
										<p><strong>Type: </strong>'.$type.'</p>											
										</div>
										<div class="card-action cyan">
										<form method="post" action="routers/inquiry-status.php">
								...
								$sql1 = mysqli_query($con, "SELECT * from inquiry_details WHERE inquiry_id = $inquiry_id;");
                  ...
                  <div class="row">
                    <form class="formValidate" id="formValidate" method="post" action="routers/inquiry-message.php" novalidate="novalidate" class="col s12">					  
                      <div class="row">
