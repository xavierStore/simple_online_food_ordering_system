    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-purple"><i class="mdi-maps-local-restaurant"></i> Order Food</a>
            </li>
                <li class="no-padding">
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-purple"><i class="mdi-action-question-answer"></i> Inquiry</a>
                            <div class="collapsible-body">
                                <ul>
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Inquiry</h5>
              </div>
            </div>
          </div>
        </div>
        <div class="container">
          <p class="caption">If you're experiencing any issues, contact us by sending an inquiry.</p>
          <div class="divider"></div>
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Send Inquiry</h4>
              </div>
<div>
                <div class="card-panel">
                  <div class="row">
                    <form class="formValidate" id="formValidate" method="post" action="routers/add-inquiry.php" novalidate="novalidate" class="col s12">
                      <div class="row">
        ...
        <div class="container">
          ...
          <div class="divider"></div>
								...
								<?php
									...
									$sql = mysqli_query($con, "SELECT * FROM inquiry WHERE poster_id = $user_id AND status LIKE '$status' AND not deleted;");
									while($row = mysqli_fetch_array($sql)){								                                
									echo'<a href="allinquiry.php?id='.$row['id'].'"class="collection-item">
                                        <div class="row">
                                            <div class="col s6">
